...
public class MildlyPopularState extends AbstractState {
     ...
     * @param result
     */
    public MildlyPopularState(ChannelContext context, Results result) {
    ...
    public void addVideo(String str,Results result) {
        ...
        result.writeToFile(MILDLY_POPULAR+"__"+ OutputConstants.VIDEO_ADDED+"::"+str.split("::")[1]);
        result.writeToStdout(MILDLY_POPULAR+"__"+ OutputConstants.VIDEO_ADDED+"::"+str.split("::")[1]);
    ...
    public void removeVideo(String str,Results result)  {
        ...
        result.writeToFile(MILDLY_POPULAR+"__"+ OutputConstants.VIDEO_REMOVED+"::"+str.split("::")[1]);
        result.writeToStdout(MILDLY_POPULAR+"__"+ OutputConstants.VIDEO_REMOVED+"::"+str.split("::")[1]);
        if((result.getPopularityScore() >= 0) && (result.getPopularityScore() <= 1000)) {
            context.setCurrentState(UNPOPULAR);
        }
        else if((result.getPopularityScore() > 1000) && (result.getPopularityScore() <= 10000)) {
    ...
    public void calculateMetrics(String str,Results result) {
        ...
        if((result.getPopularityScore() > 1000) && (result.getPopularityScore() <= 10000)) {
            result.writeToFile(MILDLY_POPULAR+"__"+ OutputConstants.POPULARITY_SCORE_UPDATE+"::"+String.format("%.2f",result.getPopularityScore()));
            result.writeToStdout(MILDLY_POPULAR+"__"+ OutputConstants.POPULARITY_SCORE_UPDATE+"::"+String.format("%.2f",result.getPopularityScore()));
        }
        else if((result.getPopularityScore() > 10000)) {
            result.writeToFile(MILDLY_POPULAR+"__"+ OutputConstants.POPULARITY_SCORE_UPDATE+"::"+String.format("%.2f",result.getPopularityScore()));
            result.writeToStdout(MILDLY_POPULAR+"__"+ OutputConstants.POPULARITY_SCORE_UPDATE+"::"+String.format("%.2f",result.getPopularityScore()));
            context.setCurrentState(HIGHLY_POPULAR);
        }
    ...
    public void requestAd(String str,Results result) {
        ...
        if((result.getAdLength() > 1) && (result.getAdLength() <= 20)) {
            result.writeToFile(MILDLY_POPULAR+"__"+ Operation.AD_REQUEST+"::APPROVED");
            result.writeToStdout(MILDLY_POPULAR+"__"+ Operation.AD_REQUEST+"::APPROVED");
        }
        else {
            result.writeToFile(MILDLY_POPULAR+"__"+ Operation.AD_REQUEST+"::REJECTED");
            result.writeToStdout(MILDLY_POPULAR+"__"+ Operation.AD_REQUEST+"::REJECTED");
        }
    }
    ...
    {
        return "MILDLY_POPULAR STATE CLASS" + "\n" + getClass().getName() + "\n" ;
    }
}
